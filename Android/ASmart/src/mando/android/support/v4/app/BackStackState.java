  ...
  implements Parcelable
{
  ...
  public BackStackState(p paramp, b paramb)
  {
    c localc1 = paramb.b;
    int j = 0;
    while (localc1 != null)
    ...
    if (localc2 != null)
    {
      ...
      for (int i1 = localc2.d.f; ; i1 = -1)
      {
        ...
        while (i8 < i6)
        {
          ...
          int i9 = i7 + 1;
          arrayOfInt9[i7] = ((Fragment)localc2.i.get(i8)).f;
          i8++;
          i7 = i9;
        }
      }
  ...
  public b a(p paramp)
  {
    ...
    for (int k = 0; k < this.a.length; k = i6)
    {
      ...
      if (i1 >= 0);
      for (localc.d = ((Fragment)paramp.f.get(i1)); ; localc.d = null)
      {
        int[] arrayOfInt3 = this.a;
        int i2 = n + 1;
        ...
        while (i8 < i7)
        {
          ...
          ArrayList localArrayList = paramp.f;
          int[] arrayOfInt8 = this.a;
          int i9 = i6 + 1;
